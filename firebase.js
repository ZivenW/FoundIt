...
// ===== EMOJI MAP berdasarkan category =====
const EMOJI_MAP = {
...
// Dipanggil setelah DOMContentLoaded dari app.js — tunggu sampai allItems tersedia
document.addEventListener("DOMContentLoaded", () => {
  const q = query(collection(db, "reports"), orderBy("createdAt", "desc"));
 
  onSnapshot(q, (snapshot) => {
    // Hapus item Firestore lama dari allItems (yang punya flag fromFirestore)
    // lalu tambahkan yang baru
